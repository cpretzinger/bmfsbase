-- Drop and recreate game tables with consistent column naming
...
-- Create game_scores table with proper UUID references
...
-- Create RLS policies with consistent user_id references
...
-- Create indexes with consistent naming
